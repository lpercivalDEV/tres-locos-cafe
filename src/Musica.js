...
function Musica() {
  return (
    <div>
          ...
          <div class="lg:w-2/3 mx-auto">
            <div class="flex flex-wrap w-full bg-gray-800 py-32 px-10 relative mb-4">
              ...
              <div class="text-center relative z-10 w-full">
                ...
                <a class="mt-3 text-red-300 inline-flex items-center">Learn More
      ...
      <iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/nku_cB06wtc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
  )
}
